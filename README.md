...
```bash
composer require mohamedgaldi/vilt-filepond-upload
```
...
php artisan vendor:publish --tag=filepond

# Or publish individual assets
php artisan vendor:publish --tag=filepond-config
php artisan vendor:publish --tag=filepond-migrations
php artisan vendor:publish --tag=filepond-vue
```
...
<script setup>
    ...
    import FileUpload from "@/Components/FilePond/FileUpload.vue";
    import { ref } from "vue";
...
<script setup>
    ...
    import FileUpload from "@/Components/FilePond/FileUpload.vue";
    import { useFilePond } from "@/Composables/FilePond/useFilePond.js";
